...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="${basePath}/js/content/ArticleAdd.js"></script>
	</head>
	<body style="background: #e1e9eb;">
		<form id="mainForm" name="mainForm" method="post" action="${basePath}/articles/add" enctype="multipart/form-data">
			<input type="hidden" id="message" value="${pageCode.msg}"/>
			<div class="right">
				<div class="current">当前位置：<a href="###">内容管理</a> &gt; 文章管理</div>
				<div class="rightCont">
					<p class="g_title fix">新增文章</p>
...
//                                        });
					...
					<div style="text-align: center; margin-top: 30px;">
                        ...
                        <a href="http://127.0.0.1:8080/sankunGardens/articles"><input class="tabSub" value="返     回" type="button" /></a>
					</div>
				</div>
			</div>
		</form>
