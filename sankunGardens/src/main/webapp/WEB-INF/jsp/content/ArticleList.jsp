...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="${basePath}/js/content/ArticleList.js"></script>
    </head>
    <body style="background: #e1e9eb;">
        <div class="current">当前位置：<a href="#">内容管理</a> &gt; 文章管理</div>
        <ul class="tree" id="treedemo">
        </ul>
        <form action="${basePath}/articles" id="mainForm" method="post">
                    ...
                    <table class="tab1">
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;" width="150">
                                ...
                                <input class="tabSub" value="添加" onclick="location.href='${basePath}/articles/addInit'" type="button"/>
                            </td>
                        </tr>
                        </tbody>
                    </table>
